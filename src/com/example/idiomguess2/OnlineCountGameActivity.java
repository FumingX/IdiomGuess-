...
public class OnlineCountGameActivity extends Activity {
	...
	private TextView LeftCount, daoju1, daoju2, GradeShow;
	...
	private RelativeLayout gradeRlLayout, onlineCountOperateLayout, gamepauseLayout, whetherExitLayout, pauseLayout;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.onlincountgame);
		...
		daoju1 = (TextView) findViewById(R.id.onlincount_promptText);
		daoju1.setText(""+InternetData.tip);
		daoju2 = (TextView) findViewById(R.id.onlincount_deleteText);
		daoju2.setText(""+InternetData.remove);
		LeftCount = (TextView) findViewById(R.id.onlincount_speakText);
		LeftCount.setText("剩余:" + C + "个");
		textblockview = new TextView[4];
		textblockview[0] = (TextView) findViewById(R.id.onlincount_blockText1);
		textblockview[1] = (TextView) findViewById(R.id.onlincount_blockText2);
		textblockview[2] = (TextView) findViewById(R.id.onlincount_blockText3);
		textblockview[3] = (TextView) findViewById(R.id.onlincount_blockText4);
		...
		time = (Chronometer) findViewById(R.id.onlincount_time);

		GradeShow = (TextView) findViewById(R.id.onlincount_score);
		GradeShow.setText("" + 0);
		Grade = 0;
		clickCount = 1;
		...
		// 图片缩放
		image = (ImageView) findViewById(R.id.onlincount_imageView1);
		...
		statu2 = (TextView) findViewById(R.id.onlincount_textView5);
		statu2.setVisibility(View.INVISIBLE);
		statu2.setTypeface(tf);
		statu2.setTextColor(Color.BLUE);

		statu3 = (TextView) findViewById(R.id.onlincount_textView6);
		statu3.setVisibility(View.INVISIBLE);
		statu3.setTextColor(Color.BLACK);

		goBack = (Button) findViewById(R.id.onlincount_button1);
		...
		goBack.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent intent = new Intent(OnlineCountGameActivity.this,OnlinePlatformActivity.class);
				startActivity(intent);
			}
		});

		gradeRlLayout = (RelativeLayout) findViewById(R.id.onlincount_gradeRlLayout);
		gradeRlLayout.setVisibility(View.GONE);
		...
		GradeLayout = (LinearLayout) findViewById(R.id.onlincount_gradelayout);
		...
		onlineCountOperateLayout = (RelativeLayout)findViewById(R.id.onlinecountoperate_layout);
		LinearLayout.LayoutParams onlineCountOperateRl = new LinearLayout.LayoutParams(
				ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
		onlineCountOperateRl.bottomMargin = screenHeight/15;
		onlineCountOperateLayout.setLayoutParams(onlineCountOperateRl);
		
		operate = (LinearLayout) findViewById(R.id.onlincount_operate);
		// show.setPadding(screenWidth/20, screenWidth/40, 0, 0);
		...
		gameBlock = (LinearLayout) findViewById(R.id.onlincount_gameBlock);
		...
		assistPool = (LinearLayout) findViewById(R.id.onlincount_assistPool);
		...
		assist = (LinearLayout) findViewById(R.id.onlincount_assist);
		LinearLayout.LayoutParams astPl = new LinearLayout.LayoutParams(
				ViewGroup.LayoutParams.MATCH_PARENT,
				ViewGroup.LayoutParams.WRAP_CONTENT);
		assist.setLayoutParams(astPl);

		prompt = (LinearLayout) findViewById(R.id.onlincount_prompt);
		...
		delete = (LinearLayout) findViewById(R.id.onlincount_delete);
		...
		blockPool = (LinearLayout) findViewById(R.id.onlincount_blockPool);
		...
		textPool = (LinearLayout) findViewById(R.id.onlincount_textPool);
		...
		blockText1 = (TextView) findViewById(R.id.onlincount_blockText1);
		...
		blockText2 = (TextView) findViewById(R.id.onlincount_blockText2);
		...
		blockText3 = (TextView) findViewById(R.id.onlincount_blockText3);
		...
		blockText4 = (TextView) findViewById(R.id.onlincount_blockText4);
		...
		buttonTip = (Button)this.findViewById(R.id.onlincount_prop1);
					...
					if(!Chengyu[i].equals("")){
						...
						try {
							...
							if(me.getInt("isTipSuccess") >= 0){
								...
								me.put("setTipNum", InternetData.tip+1);
								Toast.makeText(OnlineCountGameActivity.this,"您没有道具",Toast.LENGTH_SHORT).show();
							}	
		...
		buttonEliminate = (Button)this.findViewById(R.id.onlincount_prop2);
		...
		// 重新开始
				restart = (Button) findViewById(R.id.onlincount_restart);
				...
				pause = (Button) findViewById(R.id.onlincount_pause);
					...
					public void onClick(View v) {
						...
						if (timejudge == 1) {
							...
							Animation myAnimation = AnimationUtils.loadAnimation(
									OnlineCountGameActivity.this, R.anim.fade_in);
							...
							Animation myAnimation = AnimationUtils.loadAnimation(
									OnlineCountGameActivity.this, R.anim.fade_out);
							gamepauseLayout.startAnimation(myAnimation);
							gamepauseLayout.setVisibility(View.GONE);
				...
				returns = (Button) findViewById(R.id.onlincount_returns);
...
//						}
	...
	public void judgeGame() {
		if (true) {
			...
			buttonclick = false;
			buttonclick_2=false;
			T = Long.parseLong(time.getText().toString().split(":")[1]) * 1000 +
		                Long.parseLong(time.getText().toString().split(":")[0]) * 60000;
			...
			if (Grade > InternetData.timescore) {
				...
				try {
					jObject.put("requestType", Config.REQUEST_COUNT_SCORE);
					jObject.put("username", InternetData.username);
